...
4. Edit the default config with `make menuconfig`:
    ...
    4.3. Enable modules that are needed for the storage format which you used when formatting the boot medium in <a href="Preparing-the-boot-medium">Preparing the boot medium</a>
